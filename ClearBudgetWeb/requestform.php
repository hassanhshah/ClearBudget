  ...
  try{
     if($id != null){
       if($objUser->updaterequest($description, $cost, $id)){
         $objUser->redirect('requestindex.php?updated');
       }
     }else{
       if($objUser->insertrequest($description, $cost)){
         $objUser->redirect('requestindex.php?inserted');
       }else{
         $objUser->redirect('requestindex.php?error');
       }
     }
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                  <h1 style="margin-top: 10px">Add / Edit Requests</h1>
                  <form  method="post">
