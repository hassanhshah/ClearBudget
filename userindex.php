  ...
  try{
    if($id != null){
      if($objUser->delete($id)){
        $objUser->redirect('userindex.php?deleted');
      }
    }else{
      var_dump($id);
    }
                            ...
                            <tbody>
                                <?php if($stmt->rowCount() > 0){
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                      <a href="userform.php?edit_id=<?php print($rowUser['id']); ?>">
                                    ...
                                    <td>
                                      <a class="confirmation" href="userindex.php?delete_id=<?php print($rowUser['id']); ?>">
